...
const Message = ({ user, message, created_at }: Omit<GuestBookEntry, "id">) => {
  ...
  return (
    <article className="rounded-md border border-wine bg-raisin-black bg-opacity-20 px-6 py-4 text-raisin-black shadow-md shadow-wine dark:border-sheen-gold dark:bg-opacity-40 dark:text-silver dark:shadow-sheen-gold">
      <div className="flex justify-between">
        <div className="mb-6 flex w-1/5 items-center justify-center gap-6 rounded-md p-2 text-2xl text-raisin-black dark:text-silver">
          <div className="w-fit rounded-full border-2 border-wine bg-silver bg-opacity-20 p-2 text-3xl dark:border-sheen-gold-500">
            {avatarIcon}
          </div>
