...
const MobileNavMenu = ({ isMobileMenuOpen, toggleMobile }: { isMobileMenuOpen: boolean; toggleMobile: () => void }) => {
    ...
    return (
        <>
            ...
            <div className="menu text-raisin-black dark:text-silver flex items-center justify-center backdrop-blur-md py-4 px-4 absolute top-0 -right-12 w-screen h-screen shadow-md z-40 lg:hidden md:hidden">
